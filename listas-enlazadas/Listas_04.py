## Ejercicio 4 Implementar un algoritmo que inserte un nodo en la i-ésima posición de una
## lista.
...
unaLista.insertar(1,'hola')
unaLista.insertar(5,'cuaderno')
unaLista.insertar(2,'lampara')
unaLista.insertar(3, 'enano')


unaLista.barrido()

print('Insertamos un elemento en la lista')
unaLista.insertar(4, 'maria paula')
unaLista.barrido()
