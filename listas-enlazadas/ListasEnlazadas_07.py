...
class Lista(object) :
    ...
    def barrido(self, solo_aprobados=False) :
...
lista = Lista()
lista.insertar('Mariano', 'Pérez', 1, [Parcial("filosofia", 9, date(2020, 12, 3)), Parcial("sociologia", 10, date(2020, 11, 5)), Parcial("matematicas",8, date(2022, 9, 22))])
lista.insertar('Susana', 'Gimenez', 2, [Parcial("Teoría de la investigación", 4, date(2021, 10, 4)), Parcial("Base de Datos", 3, date(2022, 10, 5)), Parcial("Estructuras de Datos", 8, date(2020, 12, 3))])
lista.insertar("Emiliano", "LRey", 3,[Parcial("Álgebra lineal", 8, date(2021, 12, 3)), Parcial("Contabilidad", 8, date(2021, 12, 3)), Parcial("Práctica Profesional", 8, date(2022, 12, 3))])
