...
notificaciones.arribo(time(13,30), 'twitter', 'sos preciosa')
notificaciones.arribo(time(12,45), 'instagram', 'presio?')
notificaciones.arribo(time(15,10), 'twitter', 'hola! seguí nuestra banda en este link ')
notificaciones.arribo(time(11,30), 'tik tok', 'qué hacés tanto tiempo?')
notificaciones.arribo(time(4,30), 'facebook', 'excelente post')
notificaciones.arribo(time(4,30), 'twitter', 'estás aprendiendo Python? amo')
